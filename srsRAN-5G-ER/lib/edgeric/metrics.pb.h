...
class UeMetrics : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:UeMetrics) */ {
 public:
  ...
  // float tx_bytes = 4;
  void clear_tx_bytes();
  static const int kTxBytesFieldNumber = 4;
  ...
  static const int kDlBufferFieldNumber = 6;
  ::google::protobuf::uint32 dl_buffer() const;
  void set_dl_buffer(::google::protobuf::uint32 value);

  // uint32 ul_buffer = 7;
  void clear_ul_buffer();
  static const int kUlBufferFieldNumber = 7;
  ::google::protobuf::uint32 ul_buffer() const;
  void set_ul_buffer(::google::protobuf::uint32 value);

  // float dl_tbs = 8;
  void clear_dl_tbs();
  static const int kDlTbsFieldNumber = 8;
  float dl_tbs() const;
...
inline ::google::protobuf::uint32 UeMetrics::dl_buffer() const {
  // @@protoc_insertion_point(field_get:UeMetrics.dl_buffer)
  return dl_buffer_;
}
inline void UeMetrics::set_dl_buffer(::google::protobuf::uint32 value) {
...
inline ::google::protobuf::uint32 UeMetrics::ul_buffer() const {
  // @@protoc_insertion_point(field_get:UeMetrics.ul_buffer)
  return ul_buffer_;
}
inline void UeMetrics::set_ul_buffer(::google::protobuf::uint32 value) {
